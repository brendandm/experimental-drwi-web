...
/**
 * @ngdoc function
 * @name practiceMonitoringAssessmentApp.controller:AuthorizeCtrl
 * @description
 * # AuthorizeCtrl
 * Controller of the practiceMonitoringAssessmentApp
 */
angular.module('practiceMonitoringAssessmentApp').controller('AuthorizeCtrl', ['$scope', '$rootScope', '$location', 'ipCookie', function($scope, $rootScope, $location, ipCookie) {
