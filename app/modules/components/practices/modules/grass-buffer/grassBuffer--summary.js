(function() {
  ...
  angular.module('FieldDoc')
    .controller('GrassBufferSummaryController', function (Account, $location, $log, Nutrient, Nutrients, PracticeGrassBuffer, $q, $rootScope, $route, $scope, summary, user, Utility, $window) {
