...
angular.module('FieldStack')
  .controller('InstreamHabitatReportController', function (Account, Calculate, CalculateInstreamHabitat, $location, practice, PracticeInstreamHabitat, readings, $rootScope, $route, site, $scope, user, Utility) {
