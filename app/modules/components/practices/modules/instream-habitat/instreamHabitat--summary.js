...
angular.module('FieldDoc')
  .controller('InstreamHabitatSummaryController', function (Account, Calculate, CalculateInstreamHabitat, $location, practice, PracticeInstreamHabitat, readings, $rootScope, $route, site, $scope, user, Utility, $window) {
