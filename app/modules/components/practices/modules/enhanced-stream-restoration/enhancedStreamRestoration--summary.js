...
angular.module('FieldDoc')
  .controller('EnhancedStreamRestorationSummaryController', function (Account, Calculate, CalculateEnhancedStreamRestoration, $location, practice, Practice, PracticeEnhancedStreamRestoration, readings, $rootScope, $route, site, $scope, UALStateLoad, user, Utility, $window) {
