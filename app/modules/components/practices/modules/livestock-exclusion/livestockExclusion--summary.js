(function() {
  ...
  angular.module('FieldDoc')
    .controller('LivestockExclusionSummaryController', function (Account, $location, practice, PracticeLivestockExclusion, $q, $rootScope, $route, site, $scope, summary, user, Utility, $window) {
