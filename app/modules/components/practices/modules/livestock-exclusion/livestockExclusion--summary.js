...
angular.module('FieldDoc')
  .controller('LivestockExclusionSummaryController', function (Account, animals, Calculate, CalculateLivestockExclusion, Efficiency, LoadData, $location, practice, PracticeLivestockExclusion, $q, readings, $rootScope, $route, site, $scope, user, Utility, $window) {
